                    ...
                    embeds=[
                        discord.Embed(title="Fun Commands",
                                      color=discord.Color.magenta(),
                                       ...
                                       .add_field(name="blush command", value=" blush ``` /blush ```", inline=False)
                                       .add_field(name="cry command", value=" cry ``` /cry ```",inline=False)
                                       .add_field(name="dance command", value="dance ``` /dance ```", inline=False)
                                       .add_field(name="lurk command", value=" lurk ``` /lurk ```", inline=False)
                                       .add_field(name="peck command", value=" peck him/her ``` /peck ```", inline=False)
